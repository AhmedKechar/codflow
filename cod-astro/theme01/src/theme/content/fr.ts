...
export const fr: StoreFrontContent = {
  ...
  contentHeroEyebrow: "Nouvelle collection",
  contentHeroTitle: "Découvrez les meilleurs produits",
  contentHeroSubtitle: "Livraison dans toutes les wilayas d'Algérie — Paiement à la livraison",
  contentHeroCtaPrimary: "Achetez maintenant",
  contentHeroCtaSecondary: "Voir les meilleures ventes",
  contentBestSellersTitle: "Meilleures ventes",
  contentBestSellersSubtitle: "Les favoris de nos clients",
  contentNewArrivalsTitle: "Nouveautés",
  contentNewArrivalsSubtitle: "Produits fraîchement ajoutés",
  contentHowItWorksTitle: "Paiement à la livraison — Simple, sûr et fiable",
  contentHowItWorksSubtitle: "Commandez aujourd'hui, payez à la livraison",
  contentHowStep1Title: "Passez votre commande",
  contentHowStep1Sub: "Choisissez vos produits et remplissez vos coordonnées",
  contentHowStep2Title: "Confirmez via WhatsApp",
  contentHowStep2Sub: "Notre équipe vous contactera pour confirmer",
  contentHowStep3Title: "Payez à la livraison",
  contentHowStep3Sub: "Recevez votre commande et payez le livreur",
  contentFeature1: "Produits authentiques",
  contentFeature2: "Livraison rapide",
  contentFeature3: "Paiement à la livraison",
  contentFeature4: "Support 24h/24",
  contentTestimonialsTitle: "Ce que disent nos clients",
  contentTestimonialsSubtitle: "De vrais avis de vrais clients",
  contentWhatsappTitle: "Contactez-nous via WhatsApp",
  contentWhatsappSubtitle: "Nous sommes là pour vous aider à tout moment",
  contentWhatsappCta: "Commencer la conversation",
