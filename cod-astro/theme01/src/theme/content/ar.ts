...
export const ar: StoreFrontContent = {
  ...
  contentHeroEyebrow: "مجموعة جديدة",
  contentHeroTitle: "اكتشف أفضل المنتجات",
  contentHeroSubtitle: "توصيل لجميع ولايات الجزائر — الدفع عند الاستلام",
  contentHeroCtaPrimary: "تسوق الآن",
  contentHeroCtaSecondary: "عرض الأكثر مبيعاً",
  contentBestSellersTitle: "الأكثر مبيعاً",
  contentBestSellersSubtitle: "الاختيار الأول لعملائنا",
  contentNewArrivalsTitle: "وصل حديثاً",
  contentNewArrivalsSubtitle: "منتجات جديدة أُضيفت مؤخراً",
  contentHowItWorksTitle: "الدفع عند الاستلام — بسيط، آمن وموثوق",
  contentHowItWorksSubtitle: "اطلب اليوم، ادفع عند الوصول",
  contentHowStep1Title: "قدّم طلبك",
  contentHowStep1Sub: "اختر منتجاتك وأدخل بياناتك",
  contentHowStep2Title: "التأكيد عبر واتساب",
  contentHowStep2Sub: "فريقنا سيتواصل معك للتأكيد",
  contentHowStep3Title: "ادفع عند الاستلام",
  contentHowStep3Sub: "استلم طلبك وادفع لعامل التوصيل",
  contentFeature1: "منتجات أصلية",
  contentFeature2: "توصيل سريع",
  contentFeature3: "الدفع عند الاستلام",
  contentFeature4: "دعم على مدار الساعة",
  contentTestimonialsTitle: "ماذا يقول عملاؤنا",
  contentTestimonialsSubtitle: "تقييمات حقيقية من عملاء حقيقيين",
  contentWhatsappTitle: "تواصل معنا عبر واتساب",
  contentWhatsappSubtitle: "نحن هنا لمساعدتك في أي وقت",
  contentWhatsappCta: "ابدأ المحادثة",
