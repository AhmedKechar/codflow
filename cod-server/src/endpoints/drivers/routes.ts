...
const createDriverRoute = defineRoute({
  ...
  responses: {
    ...
    400: { description: "Validation error (invalid phone format, missing required fields)" },
    403: { description: "Missing delivery:manage scope" },
    409: { description: "Duplicate phone number - a driver with this phone already exists (code: DUPLICATE_PHONE)" },
  },
...
const getDriverRoute = defineRoute({
  ...
  responses: {
    ...
    403: { description: "Missing delivery:read scope" },
    404: { description: "Driver not found (DRIVER_NOT_FOUND)" },
  },
...
const updateDriverStatusRoute = defineRoute({
  ...
  responses: {
    ...
    400: { description: "Validation error (invalid status value)" },
    403: { description: "Missing delivery:manage scope" },
    404: { description: "Driver not found (DRIVER_NOT_FOUND)" },
  },
...
const deleteDriverRoute = defineRoute({
  ...
  responses: {
    ...
    403: { description: "Missing delivery:manage scope" },
    404: { description: "Driver not found (DRIVER_NOT_FOUND)" },
    409: { description: "Cannot delete driver with active orders (code: DRIVER_HAS_ACTIVE_ORDERS)" },
  },
...
const setCompensationRoute = defineRoute({
  ...
  responses: {
    ...
    400: { description: "Validation error (negative fee, invalid wilayaId)" },
    403: { description: "Missing delivery:manage scope" },
    404: { description: "Driver not found (DRIVER_NOT_FOUND)" },
  },
