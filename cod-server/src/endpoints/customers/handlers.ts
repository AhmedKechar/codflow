...
export async function listCustomers(c: Context<AppContext>) {
  ...
  const customers = await queries.getAllCustomers(db, storeId, filters);
...
export async function getCustomer(c: Context<AppContext>) {
  ...
  const customer = await queries.getCustomerById(db, storeId, customerId);
...
export async function createCustomer(c: Context<AppContext>) {
  ...
  const existingCustomer = await queries.getCustomerByPhone(db, storeId, validated.phone);
  if (existingCustomer) {
...
export async function updateCustomer(c: Context<AppContext>) {
  ...
  const customer = await queries.updateCustomer(db, storeId, customerId, validated);
...
export async function listCustomerOrders(c: Context<AppContext>) {
  ...
  const orders = await queries.getOrdersByCustomerId(db, storeId, customerId);
...
export async function listCustomerGroups(c: Context<AppContext>) {
  ...
  const groups = await queries.getCustomerGroupMemberships(db, storeId, customerId);
...
export async function listCustomerTags(c: Context<AppContext>) {
  ...
  const tags = await queries.getCustomerTagMemberships(db, storeId, customerId);
...
export async function deleteCustomer(c: Context<AppContext>) {
  ...
  await queries.deleteCustomer(db, storeId, customerId);
