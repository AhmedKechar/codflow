...
const createGroupRoute = defineRoute({
  ...
  responses: {
    201: {
      ...
      content: { "application/json": { schema: SuccessResponseSchema(ProductCategorySchema) } },
    },
    400: { description: "Validation error (missing name, invalid slug or URL)" },
    403: { description: "Missing product_groups:manage scope" },
  },
...
const updateGroupRoute = defineRoute({
  ...
  responses: {
    ...
    400: { description: "Validation error (invalid slug or URL)" },
    403: { description: "Missing product_groups:manage scope" },
    404: { description: "Product group not found" },
  },
