...
const listMessagesRoute = defineRoute({
  ...
  description: "Get all WhatsApp messages for the store with optional filters.",
...
const sendMessageRoute = defineRoute({
  ...
  description: "Send a WhatsApp message to a phone number. Creates a message record and sends via WhatsApp Business API.",
