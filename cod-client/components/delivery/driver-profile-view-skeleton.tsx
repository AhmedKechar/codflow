...
export function DriverProfileViewSkeleton() {
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-card rounded-lg border-border p-6 md:p-8">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 shrink-0 lg:w-56 w-full">
            ...
            <Skeleton className="h-20 rounded-lg" />
            <Skeleton className="h-20 rounded-lg col-span-2 lg:col-span-1" />
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-card rounded-lg border-border overflow-hidden">
          <div className="p-0">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-center justify-between p-6 border-b border-border/20 last:border-0">
